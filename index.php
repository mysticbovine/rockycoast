...
<html lang="en">
  <head>
    ...
    <title>Rob Evans Web Professional</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    <link rel="icon" href="favicon.ico" type="image/x-icon">
    <meta name="description" content="Portfolio website of Rob Evans: Web Professional" />
    <meta name="keywords" content="html, css, css3, jquery, php, drupal, print, design, development" />
    <meta name="author" content="Rob Evans" />
    ...
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,800,300,700,400italic' rel='stylesheet' type='text/css'>
          ...
          <div class="row">
              <div class="col-sm-6 col-md-5 col-lg-3">
                <header class="corner-stamp header">
                    <h1><span>Rob</span>Evans</h1>
                    <h2>web professional</h2>
                    <h2><sup>and more</sup></h2>
                    <div class="row contact">
                        <div class="col-xs-6">
                            <span class="phone no-mobile">phone</span><a href="tel:16048627875">604 862 7875</a>
                        </div>
                        <div class="col-xs-6">
                            <span class="email no-mobile">email</span><a href="mailto:rob@alacarde.ca">rob@alacarde.ca</a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 mix block element <?php print $filters; ?> item<?php print $i; ?>" data-bgimage="images/portfolio/<?php print $portfolio[$i]["images"][0][0]; ?>" >
						<div class="wrapper">
							...
							<div class="project-descr" style="display: none">
								...
								<span class="less filter" data-filter="all" style="display: none;">Less</span>	
							<p class="subline" data-option-key="filter">Tags: <span class="description">(click a tag to filter projects)</span></p>
								<ul class="filters">
									<?php ## tag loop ##
											$t=0;
